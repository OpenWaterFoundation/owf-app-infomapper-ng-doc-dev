...
|`MainTitleFontName`|Name of font to use for main title (`Arial`, `Courier`, `Helvetica`, `TimesRoman`). **Not currently implemented.**|`Arial`|
|`MainTitleFontSize` **Not currently implemented.**|Size, in points, for main title.|`20`|
|`MainTitleFontStyle` **Not currently implemented.**|Font style (`Bold`, `BoldItalic`, `Plain`, `PlainItalic`).|`Plain`|
...
|`SubTitleFontSize` **Not currently implemented.**|Size, in points, for subtitle.|`10`|
